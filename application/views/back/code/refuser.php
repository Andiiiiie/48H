...
<div class="right_col" role="main">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Refus d'utilisation du code pour l'utilisateur</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                    <p class="text-muted font-13 m-b-30">
                        Vous confirmer le refus du code <span class="text-primary"><?= $code['code']['code'] ?></span>
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post">
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                ...
                                <button type="submit" class="btn btn-danger">Refuser la transaction</button>
                            </div>
                        </div>
