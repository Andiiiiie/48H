...
<div class="right_col" role="main">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Suppression d'une activite</h2>
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <img src="<?= base_url($sport['image_path']) ?>" alt="Photo de description actuelle" class="img-responsive">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control col-md-7 col-xs-12" name="designation"
                                       value="<?= set_value('composition', $sport['designation']) ?>" disabled>
                            </div>
                        </div>
                        <div class="ln_solid"></div>
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <a class="btn btn-success" href="<?= site_url('back/sport/liste') ?>">Retourner à la liste</a>
                                <button type="submit" class="btn btn-danger">Supprimer l'activite</button>
                            </div>
                        </div>
